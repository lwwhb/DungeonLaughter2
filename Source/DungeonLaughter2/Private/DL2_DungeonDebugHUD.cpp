...
ADL2_DungeonDebugHUD::ADL2_DungeonDebugHUD()
{
#if WITH_EDITOR
    m_pDungeonRoot = nullptr;
#endif // WITH_EDITOR
}
void ADL2_DungeonDebugHUD::BeginPlay()
{
    Super::BeginPlay();
...
void ADL2_DungeonDebugHUD::DrawHUD()
{
    Super::DrawHUD();
#if WITH_EDITOR
...
void ADL2_DungeonDebugHUD::EnableSteps()
{
    showSteps = true;
    enableStep1 = false;
    enableStep2 = false;
    ...
    enableStep6 = false;
    enableStep7 = false;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep1, 1.0f, false);
}
void ADL2_DungeonDebugHUD::DisableSteps()
{
    showSteps = false;
}
void ADL2_DungeonDebugHUD::EnableStep1()
{
    enableStep1 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep2, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep2()
{
    enableStep2 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep3, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep3()
{
    enableStep3 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep4, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep4()
{
    enableStep4 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep5, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep5()
{
    enableStep5 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep6, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep6()
{
    enableStep6 = true;
    GetWorldTimerManager().SetTimer(m_TimerHandle, this, &ADL2_DungeonDebugHUD::EnableStep7, 1.0f, false);
}
void ADL2_DungeonDebugHUD::EnableStep7()
{
    enableStep7 = true;
}

void ADL2_DungeonDebugHUD::DrawBackground()
{
...
void ADL2_DungeonDebugHUD::DrawConnectAreas()
{
    //ªÊ÷∆¡¨Ω”«¯”Ú
...
void ADL2_DungeonDebugHUD::DrawSplitLines()
{
    ///ªÊ÷∆∑÷∏Ó«¯”Ú
    if (enableStep4)
    {
...
void ADL2_DungeonDebugHUD::DrawEntranceAreaAndExitArea()
{
    ///ªÊ÷∆≥ˆ»Îø⁄
...
void ADL2_DungeonDebugHUD::DrawFinalMap()
{
    if (!m_pDungeonRoot || !m_pDungeonRoot->getCurrentDungeonNode())
        return;
...
void ADL2_DungeonDebugHUD::DrawStatistics()
{
    if (!m_pDungeonRoot || !m_pDungeonRoot->getCurrentDungeonNode())
        return;
...
void ADL2_DungeonDebugHUD::DrawCircle(const FVector2D& Center, const FColor& Color, int32 NumSides, float Radius)
{
...
void ADL2_DungeonDebugHUD::DrawDungeonNode(UDungeonNodeComponent* node, const FVector2D& Center)
{
    FColor color;
...
void ADL2_DungeonDebugHUD::DrawDungeonTreeInfo()
{
    if (!m_pDungeonRoot || !m_pDungeonRoot->getCurrentDungeonNode())
        return;	
